        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" method="post" action="<?php echo base_admin_url() . 'update-chart'; ?>">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Chart</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Chart Name</label>
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" class="form-control" name="chart_name" id="chart_name" placeholder="Chart Name.." value="<?php echo ($user_data) ? $user_data['chart'] : ''; ?>" required="">
