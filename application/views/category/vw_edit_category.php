                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo base_admin_url() . 'update-category'; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Is Regional ?</label>

                                        <div class="col-sm-9">

                                            <select class="form-control" id="is_regional" name="is_regional">

                                                <option value="1" <?php if($user_data['is_regional'] == '1'){ echo "selected";}?>>Yes</option>

                                                <option value="0" <?php if($user_data['is_regional'] == '0'){ echo "selected";}?>>No</option>
